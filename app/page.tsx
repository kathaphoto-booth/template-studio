...
export default function WorkspacePage() {
  ...
  useEffect(() => {
    return () => {
      if (customBasePhoto && customBasePhoto.startsWith("blob:")) {
        URL.revokeObjectURL(customBasePhoto);
      }
    };
  }, [customBasePhoto]);
  ...
  return (
    <main id="app-root-container" className="min-h-screen bg-[#FAF9F5] text-stone-900 flex flex-col font-sans selection:bg-stone-200 selection:text-stone-950">
      ...
      <header id="app-header" className="h-16 border-b border-stone-200/60 bg-white px-6 md:px-10 flex items-center justify-between sticky top-0 z-50 ">
        ...
        <div className="flex items-center space-x-6 text-xs">
          ...
          <div className="hidden sm:flex flex-col items-end border-l border-stone-200 pl-6">
            ...
            <span className="font-mono text-stone-800 font-bold flex items-center gap-1.5 text-[10.5px]">
              <span className="w-1.5 h-1.5  bg-amber-600 animate-pulse" /> Precision Vectors active
            </span>
          </div>
        </div>
      </header>
      ...
      {showDraftBanner && draftSelection && (
        <div className="bg-[#FAF1EA] border-b border-[#C4B59D]/50 px-6 py-2.5 flex items-center justify-between text-xs text-stone-800 animate-fade-in relative z-40">
          <div className="flex items-center gap-2">
            <span className="inline-flex items-center justify-center bg-[#8C382A]/10 text-[#8C382A]  w-5 h-5 font-bold text-[10px]">✨</span>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="bg-stone-900 hover:bg-stone-800 text-white font-bold py-1 px-3  uppercase tracking-wider text-[9px] transition-all cursor-pointer"
            >
      ...
      <div id="app-workspace-body" className="flex-1 flex flex-col lg:flex-row min-h-0">
        ...
        <aside id="workspace-sidebar" className="lg:w-[380px] border-b lg:border-b-0 lg:border-r border-stone-200 bg-white p-5 flex flex-col gap-5 shrink-0 overflow-y-auto lg:h-[calc(100vh-64px)]">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-1 p-1 bg-stone-50  border border-stone-200/80">
              <button
                id="toggle-factor-strip"
                onClick={() => handleTypeToggle("strip")}
                className={cn(
                  "py-1.5 px-0.5 text-[9.5px] font-bold uppercase tracking-wider text-center cursor-pointer transition-all  leading-tight",
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-2">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-stone-50 border border-stone-200 p-2 text-xs focus:outline-none focus:ring-1 focus:ring-stone-900 focus:bg-white "
                />
              </div>
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="space-y-1 col-span-1">
                ...
                <select
                  ...
                  className="w-full bg-stone-50 border border-stone-200 p-1.5 text-xs focus:outline-none focus:ring-1 focus:ring-stone-900 font-bold  text-center"
                >
                  <option value="&amp;">&amp;</option>
              ...
              <div className="space-y-1 col-span-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-stone-50 border border-stone-200 pl-8 pr-2 py-1.5 text-xs focus:outline-none focus:ring-1 focus:ring-stone-900 focus:bg-white "
                  />
          ...
          <div className="border-t border-stone-100 pt-4 space-y-4">
            ...
            {/* Names Font */}
            <div className="space-y-1.5 bg-stone-50/50 p-2.5  border border-stone-200/60 text-left">
              ...
              <select
                ...
                className="w-full bg-white border border-stone-250 p-1.5 text-xs  focus:outline-none focus:ring-1 focus:ring-stone-900 font-mono text-[11px]"
              >
                {LUXURY_FONTS.map(f => (
              ...
              <div className="flex items-center gap-3 pt-1">
                <div className="flex-1 space-y-0.5">
                  ...
                  <input
                    ...
                    className="w-full h-[2px] bg-stone-200 appearance-none cursor-pointer focus:outline-none focus:ring-1 focus:ring-[#8A7342]/40 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-2.5 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:bg-[#8A7342] [&::-webkit-slider-thumb]:rounded-none"
                  />
                </div>
                <div className="flex-1 space-y-0.5">
              ...
              <div className="flex items-center gap-2 pt-1.5">
                <button
                  ...
                  className={cn(
                    "text-[9px] px-2 py-1  border uppercase tracking-widest cursor-pointer",
                ...
                <select
                  ...
                  className="bg-white border border-stone-200 p-1 text-[9px]  uppercase tracking-wider"
                >
              ...
              <div className="flex items-center gap-3 pt-1">
                <div className="flex-1 space-y-0.5">
                  ...
                  <input
                    ...
                    className="w-full h-[2px] bg-stone-200 appearance-none cursor-pointer focus:outline-none focus:ring-1 focus:ring-stone-600/40 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-2.5 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:bg-stone-700 [&::-webkit-slider-thumb]:rounded-none"
                  />
                </div>
                <div className="flex-1 space-y-0.5">
          ...
          <div className="border-t border-stone-100 pt-4 space-y-4">
            ...
            <div className="space-y-1.5  bg-amber-500/5 border border-stone-200/60 p-2.5">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className={cn(
                    "text-[10px] py-1.5 font-semibold  border uppercase tracking-wider text-center cursor-pointer transition-all",
                    textPosition === "bottom" 
            ...
            <div className="space-y-1 bg-amber-500/5 p-2.5  border border-stone-200/60">
              <div className="flex justify-between text-[11px] text-stone-600">
                <span className="font-bold text-[#8A7342]">Background Graphic Opacity</span>
                <span className="font-mono text-[10px] bg-amber-50 px-1 border border-amber-200 text-amber-800 ">{graphicOpacity}%</span>
              </div>
              <input
          ...
          <div className="flex flex-col items-center space-y-5 max-w-full">
            ...
            <div className="flex items-center justify-between w-full max-w-lg bg-white border border-stone-200 p-2 text-xs gap-2">
              ...
              <button
                ...
                className={cn(
                  "px-2 py-0.5 font-bold text-[8.5px] uppercase tracking-wider flex items-center gap-1 transition-all cursor-pointer border ",
                  useTransparentSlots 
            ...
            <div 
              ...
              className={cn(
                "border border-stone-200 relative select-none p-1 bg-white",
            ...
            {/* Design summary log */}
            <div className="bg-white border border-stone-200 py-3.5 px-5 rounded-none max-w-lg  flex items-start space-x-3.5 text-left">
        ...
        <aside id="sidebar-photo-sources" className="lg:w-80 border-t lg:border-t-0 lg:border-l border-stone-200 bg-white p-5 flex flex-col gap-5 shrink-0 overflow-y-auto lg:h-[calc(100vh-64px)]">
            ...
            <div className="space-y-2 max-h-[360px] overflow-y-auto pr-1">
              {PRESETS.map((p) => (
                <button
                  ...
                  className={cn(
                    "w-full text-left p-2.5 flex flex-col gap-1 transition-all border  cursor-pointer",
                    currentPreset.id === p.id
                      ? "border-[#8A7342] bg-[#FAF8F3] "
          ...
          <div className="border-t border-stone-100 pt-4 space-y-2 text-left">
            ...
            {customBasePhoto ? (
              <div className="p-2.5 bg-stone-50 border border-stone-200  flex items-center gap-2.5">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      clearCustomBasePhoto();
                    }}
                    className="text-[8.5px] font-bold uppercase tracking-widest text-rose-600 hover:text-rose-700 bg-rose-50 px-1.5 py-0.5  mt-0.5 cursor-pointer"
                  >
                    Remove base
                  </button>
                </div>
              ...
              <div className="p-3 bg-stone-50/50 border border-dashed border-stone-200  text-center space-y-2 animate-fade-in">
                <p className="text-[9px] text-stone-500 leading-dense">
                  Upload custom visual background bases to layer behind the frames.
                </p>
                <label className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white hover:bg-stone-50 border border-stone-200 text-stone-800 text-[9px] font-bold uppercase tracking-wider cursor-pointer transition-colors  ">
          ...
          <div className="border-t border-stone-100 pt-4 space-y-3 mr-0.5">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-[9px] font-bold uppercase tracking-widest text-[#8A7342] hover:text-[#705c31] flex items-center gap-1 px-2 py-0.5 bg-amber-500/5  border border-amber-500/10 hover:border-amber-500/20 transition-all cursor-pointer"
              >
              ...
              {HARMONY_PALETTES.map((palette) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "w-full text-left p-2  border cursor-pointer transition-all flex items-center justify-between gap-3",
                      isActive 
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1 bg-stone-100/50 p-1  border border-stone-250 shrink-0">
                      <span className="w-3 h-3  border border-stone-300" style={{ backgroundColor: palette.bg }} />
                      <span className="w-3 h-3  border border-stone-300" style={{ backgroundColor: palette.text }} />
                      <span className="w-3 h-3  border border-stone-300" style={{ backgroundColor: palette.secondary }} />
                      <span className="w-3 h-3  border border-stone-300" style={{ backgroundColor: palette.border }} />
                    </div>
                  </button>
                );
              })}
              ...
              <div className="space-y-0.5">
                ...
                <div className="flex items-center gap-1.5">
                  <input
                    ...
                    className="w-5.5 h-5.5 cursor-pointer  border border-stone-200"
                  />
          ...
          <div className="border-t border-stone-100 pt-4 space-y-3.5">
            <div className="space-y-1.5 text-left bg-stone-50/80 p-2.5  border border-stone-200/50">
              ...
              <div className="grid grid-cols-4 gap-1 mt-2">
                <button
                  ...
                  className={cn(
                    "text-[8px] font-bold py-1.5 px-1  uppercase tracking-wider text-center border cursor-pointer transition-all",
              ...
              {exportMode === "luma-overlay" && (
                <div className="mt-2 p-1.5 bg-amber-50 border border-amber-200  space-y-1">
              ...
              {exportMode === "layers" && (
                <div className="mt-2 p-1.5 bg-white border border-[#E9E4DC]  space-y-1">
              ...
              {exportMode === "pdf-print" && (
                <div className="mt-2 space-y-2 p-1.5 bg-white border border-[#E9E4DC]  text-left">
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-1">
                      <button
                        ...
                        className={cn(
                          "text-[8px] font-bold py-1 px-1.5  uppercase text-center border cursor-pointer transition-all",
              ...
              <div className="mt-2 pt-2 border-t border-stone-150 flex items-center justify-between">
                ...
                <button
                  ...
                  className={cn(
                    "relative inline-flex h-4 w-8 shrink-0 cursor-pointer  transition-colors duration-200 ease-in-out border border-transparent",
                    exportCmykMode ? "bg-[#8A7342]" : "bg-stone-200"
                  )}
                >
                  <span
                    className={cn(
                      "pointer-events-none inline-block h-3 w-3 transform  bg-white  ring-0 transition duration-200 ease-in-out",
            ...
            <button
              ...
              className="w-full bg-stone-900 border border-stone-900 hover:bg-stone-850 text-white text-xs font-bold uppercase tracking-widest py-3 flex items-center justify-center gap-2 transition-all cursor-pointer  "
            >
            ...
            <button
              ...
              className="w-full bg-[#FCFAF5] border border-stone-200 hover:bg-stone-50 text-stone-800 text-[10px] font-bold uppercase tracking-widest py-2 flex items-center justify-center gap-1.5 transition-all cursor-pointer "
            >
