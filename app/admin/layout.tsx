...
export default function AdminLayout({ children }: { children: ReactNode }) {
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#111112", color: "#EAE2D5", fontFamily: "'Hanken Grotesk', Georgia, serif" }}>
      {/* Top bar */}
      <div style={{ borderBottom: "1px solid rgba(196,181,157,0.18)", padding: "20px 40px", display: "flex", alignItems: "baseline", gap: "24px" }}>
        <span style={{ fontFamily: "'Inter', sans-serif", fontSize: "10px", textTransform: "uppercase", letterSpacing: "0.3em", color: "#DCCBB5", fontWeight: 700 }}>
          Katha
        </span>
        <span style={{ fontFamily: "'Playfair Display', serif", fontSize: "20px", fontWeight: 400, color: "#EAE2D5", letterSpacing: "-0.01em" }}>
          Studio Admin
        </span>
