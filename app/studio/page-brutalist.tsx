...
export default function WorkspacePage() {
  ...
  return (
    <main id="app-root-container" className="h-screen w-screen overflow-hidden bg-[#0a0a0a] text-[#8e8e8e] flex flex-col font-mono selection:bg-[#2a2a2a] selection:text-white">
      
      {/* Brutalist Header */}
      <header id="app-header" className="h-12 shrink-0 border-b border-[#2a2a2a] bg-[#0a0a0a] px-4 flex items-center justify-between z-50">
        <div className="flex items-center space-x-6">
          <button className="text-[#8e8e8e] hover:text-white transition-colors" aria-label="Menu">
          ...
          <div className="flex items-center space-x-3 text-xs">
            <span className="w-3.5 h-3.5 border border-[#8e8e8e] rounded-xs flex items-center justify-center">
              <span className="w-1.5 h-1.5 bg-[#8e8e8e]"></span>
            </span>
            <span className="text-stone-300 font-bold uppercase tracking-widest">Aperçu Mono</span>
          </div>
        </div>
        <div className="flex items-center space-x-6 text-[10px] uppercase tracking-widest text-[#8e8e8e]">
          <div className="flex items-center space-x-5">
            <button className="hover:text-white flex items-center space-x-1.5 transition-colors">
              <Download className="w-3.5 h-3.5"/><span>Save</span>
            </button>
            <button className="hover:text-white flex items-center space-x-1.5 transition-colors" aria-label="Undo">
              <RotateCcw className="w-3.5 h-3.5"/>
            </button>
            <button className="hover:text-white flex items-center space-x-1.5 transition-colors" aria-label="Redo">
              <RefreshCw className="w-3.5 h-3.5"/>
            </button>
          </div>
          <div className="flex items-center space-x-2 bg-[#111112] px-3 py-1.5 border border-[#2a2a2a]">
      ...
      {showDraftBanner && draftSelection && (
        <div className="bg-[#111112] border-b border-[#2a2a2a] px-6 py-2.5 flex items-center justify-between text-[10px] uppercase tracking-widest text-stone-300 animate-fade-in shrink-0 z-40">
          <div className="flex items-center gap-3">
            <span className="inline-flex items-center justify-center bg-white/10 border border-[#2a2a2a] text-white w-5 h-5 font-bold">✨</span>
            <span className="font-mono">
              Found draft for <span className="text-white font-bold">{draftSelection.names || "Gallery Guest"}</span> ({draftSelection.templateName}).
            </span>
          </div>
          <div className="flex items-center gap-4">
            <button
              onClick={applyDraftSelection}
              className="bg-white text-black font-bold py-1 px-4 hover:bg-stone-200 transition-colors cursor-pointer"
            >
              APPLY DRAFT
            </button>
            <button
              onClick={() => setShowDraftBanner(false)}
              className="text-[#8e8e8e] hover:text-white font-bold transition-all cursor-pointer"
      ...
      <div id="app-workspace-body" className="flex-1 flex min-h-0 overflow-hidden">
        ...
        {/* LEFT PANE: TEMPLATE OBJECTS */}
        <aside className="w-[320px] shrink-0 border-r border-[#2a2a2a] bg-[#0a0a0a] flex flex-col overflow-y-auto text-[10px] uppercase tracking-widest text-[#8e8e8e] font-mono scrollbar-hide">
          <div className="border-b border-[#2a2a2a] py-3 px-4 text-[#d4d4d4] font-bold">
            TEMPLATE OBJECTS
          </div>
          <div className="p-4 space-y-6">
            ...
            {/* Stage */}
            <div>
               <div className="flex items-center space-x-2 mb-3 text-[#d4d4d4]">
                 <Layers className="w-3.5 h-3.5"/>
                 <span>STAGE</span>
               </div>
               <div className="ml-5 space-y-2 border-l border-[#2a2a2a] pl-3">
                 <div className="flex items-center space-x-2">
                    <span className="w-2.5 h-2.5 border border-[#8e8e8e]"></span>
                 ...
                 {(() => {
                   ...
                   return lay.slots.map((s: any, i: number) => (
                     <div key={i} className="space-y-1.5">
                        <div className={cn("flex items-center space-x-2 py-1 px-2 -ml-2 rounded-sm", i === 0 ? "bg-[#2a4d36] text-[#b3f0c2] border border-[#3a6b4b]" : "hover:text-white")}>
                          <Camera className="w-3.5 h-3.5"/>
                          <span>PHOTO_{String(i+1).padStart(2, '0')}</span>
                        </div>
                        {i === 0 && (
                          <div className="ml-5 text-[9px] text-[#8e8e8e] space-y-1">
                 ...
                 <div className="flex items-center space-x-2 hover:text-white py-1">
            ...
            <div className="pt-4 border-t border-[#2a2a2a] space-y-4">
              <div className="text-[#d4d4d4] font-bold mb-3">PROPERTIES</div>
              
              <div className="bg-[#111112] border border-[#2a2a2a] p-2 text-white">
                PHOTO_01
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-[1fr_auto] gap-y-2 gap-x-4">
                  ...
                  <span className="bg-[#111112] border border-[#2a2a2a] px-2 py-1 text-right min-w-[80px]">{slotBorderWidth}</span>
                  
                  <span className="flex items-center">Color</span>
                  <span className="bg-[#111112] border border-[#2a2a2a] px-2 py-1 text-right min-w-[80px] lowercase">{borderColor}</span>
                  
                  <span className="flex items-center">Radius</span>
                  <span className="bg-[#111112] border border-[#2a2a2a] px-2 py-1 text-right min-w-[80px]">{slotBorderRadius}</span>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between items-center">
                  <span>Scale</span>
                  <span className="bg-[#111112] border border-[#2a2a2a] px-2 py-1 text-right min-w-[80px]">1.00x</span>
                </div>
              </div>
        ...
        {/* CENTER PANE: CANVAS */}
        <section className="flex-1 bg-[#0a0a0a] relative overflow-auto flex items-center justify-center border-t border-transparent">
          {/* Rulers / grid overlay */}
          <div className="absolute inset-0 pointer-events-none" style={{ backgroundImage: 'linear-gradient(to right, #2a2a2a 1px, transparent 1px), linear-gradient(to bottom, #2a2a2a 1px, transparent 1px)', backgroundSize: '100px 100px', opacity: 0.3 }}></div>
          ...
          <div 
            ...
            className={cn(
              "relative select-none p-1 ring-1 ring-[#444] shadow-[0_0_50px_rgba(0,0,0,0.5)] z-10",
              useTransparentSlots ? "bg-[radial-gradient(#333_1px,transparent_1px)] [background-size:16px_16px]" : "bg-[#f5f2eb]"
            )}
          >
            <div
              style={{
                ...
                {(() => {
                  ...
                  return lay.slots.map((s: { x: number; y: number; w: number; h: number }, idx: number) => {
                    ...
                    >
                      ...
                      <span className="absolute -top-[5px] -left-[5px] w-2.5 h-2.5 border-t border-l border-stone-500/40 pointer-events-none"></span>
                      <span className="absolute -top-[5px] -right-[5px] w-2.5 h-2.5 border-t border-r border-stone-500/40 pointer-events-none"></span>
                      <span className="absolute -bottom-[5px] -left-[5px] w-2.5 h-2.5 border-b border-l border-stone-500/40 pointer-events-none"></span>
                      <span className="absolute -bottom-[5px] -right-[5px] w-2.5 h-2.5 border-b border-r border-stone-500/40 pointer-events-none"></span>
                    </label>
                    );
                  });
                })()}
            ...
            <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-px h-4 bg-[#444]" />
            <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 w-px h-4 bg-[#444]" />
            <div className="absolute top-1/2 -left-6 -translate-y-1/2 w-4 h-px bg-[#444]" />
            <div className="absolute top-1/2 -right-6 -translate-y-1/2 w-4 h-px bg-[#444]" />
          </div>
        </section>

        {/* RIGHT PANE: CONFIGURATION */}
        <aside className="w-[320px] shrink-0 border-l border-[#2a2a2a] bg-[#0a0a0a] flex flex-col overflow-y-auto text-[10px] uppercase tracking-widest text-[#8e8e8e] font-mono scrollbar-hide">
          <div className="border-b border-[#2a2a2a] py-3 px-4 text-[#d4d4d4] font-bold">
            CONFIGURATION
          </div>
          <div className="p-4 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <span>Masking</span>
                  <button onClick={() => setUseTransparentSlots(!useTransparentSlots)} className={cn("px-3 py-1.5 border transition-colors", useTransparentSlots ? "bg-[#1a1a1a] border-[#2a4d36] text-[#b3f0c2]" : "bg-[#111112] border-[#2a2a2a]")}>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <select 
                    ...
                    className="bg-[#111112] border border-[#2a2a2a] text-white px-2 py-1.5 outline-none min-w-[120px] appearance-none"
                  >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <select 
                    ...
                    className="bg-[#111112] border border-[#2a2a2a] text-white px-2 py-1.5 outline-none w-[120px] appearance-none"
                  >
                    {PRESETS.map(p => (
            ...
            <div className="space-y-3 pt-3 border-t border-[#2a2a2a]">
              ...
              <select 
                ...
                className="w-full bg-[#111112] border border-[#2a2a2a] text-white px-2 py-1.5 outline-none appearance-none"
              >
            ...
            {/* SPACING */}
            <div className="space-y-3 pt-3 border-t border-[#2a2a2a]">
              <div className="text-white">SPACING / OPACITY</div>
              <div className="grid grid-cols-[auto_1fr_auto] gap-x-3 gap-y-2 items-center">
                  ...
                  />
                  <span className="bg-[#111112] border border-[#2a2a2a] px-2 py-1.5 w-12 text-center text-white">{graphicOpacity}%</span>
              </div>
            ...
            {/* TYPOGRAPHY */}
            <div className="space-y-3 pt-3 border-t border-[#2a2a2a]">
              <div className="text-white">TYPOGRAPHY</div>
              <div className="space-y-2">
                <input
                  type="text"
                  ...
                  className="w-full bg-[#111112] border border-[#2a2a2a] text-white px-3 py-2 outline-none placeholder:text-[#555] focus:border-white transition-colors"
                />
                <input
                  type="text"
                ...
                <select
                    ...
                    className="w-full bg-[#111112] border border-[#2a2a2a] text-white px-3 py-2 outline-none font-mono focus:border-white transition-colors appearance-none"
                  >
                    {LUXURY_FONTS.map(f => (
            ...
            <div className="space-y-3 pt-3 border-t border-[#2a2a2a]">
              ...
              <div className="space-y-2">
                ...
                {exportMode === "pdf-print" && (
                  <div className="flex justify-between items-center">
                    <span>CMYK</span>
                    <button onClick={() => setExportCmykMode(!exportCmykMode)} className={cn("px-3 py-1.5 border transition-colors", exportCmykMode ? "bg-[#1a1a1a] border-[#2a4d36] text-[#b3f0c2]" : "bg-[#111112] border-[#2a2a2a]")}>
              ...
              <button 
                ...
                className="w-full bg-white text-black font-bold py-2.5 hover:bg-stone-200 transition-colors cursor-pointer mt-2 tracking-widest"
              >
                EXPORT NOW
              </button>
            </div>
