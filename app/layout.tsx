  ...
  return (
    <html lang="en" className={`${inter.variable} ${playfair.variable} ${fraunces.variable}`}>
      <head>
        ...
        <link rel="preload" href="https://fonts.googleapis.com/css2?family=Aboreto&family=Alex+Brush&family=Bodoni+Moda:ital,opsz,wght@0,6..96,400..900;1,6..96,400..900&family=Cinzel:wght@400..900&family=EB+Garamond:ital,wght@0,400..800;1,400..800&family=Great+Vibes&family=Italiana&family=JetBrains+Mono:wght@400..700&family=La+Belle+Aurore&family=Montserrat:wght@100..900&family=Parisienne&family=Pinyon+Script&family=Playfair+Display:ital,wght@0,400..900;1,400..900&family=Rochester&family=Sacramento&display=swap" as="style" fetchPriority="high" />
        <link href="https://fonts.googleapis.com/css2?family=Aboreto&family=Alex+Brush&family=Bodoni+Moda:ital,opsz,wght@0,6..96,400..900;1,6..96,400..900&family=Cinzel:wght@400..900&family=EB+Garamond:ital,wght@0,400..800;1,400..800&family=Great+Vibes&family=Italiana&family=JetBrains+Mono:wght@400..700&family=La+Belle+Aurore&family=Montserrat:wght@100..900&family=Parisienne&family=Pinyon+Script&family=Playfair+Display:ital,wght@0,400..900;1,400..900&family=Rochester&family=Sacramento&display=swap" rel="stylesheet" precedence="default" />
        <noscript>
          <link href="https://fonts.googleapis.com/css2?family=Aboreto&family=Alex+Brush&family=Bodoni+Moda:ital,opsz,wght@0,6..96,400..900;1,6..96,400..900&family=Cinzel:wght@400..900&family=EB+Garamond:ital,wght@0,400..800;1,400..800&family=Great+Vibes&family=Italiana&family=JetBrains+Mono:wght@400..700&family=La+Belle+Aurore&family=Montserrat:wght@100..900&family=Parisienne&family=Pinyon+Script&family=Playfair+Display:ital,wght@0,400..900;1,400..900&family=Rochester&family=Sacramento&display=swap" rel="stylesheet" precedence="default" />
        </noscript>
      </head>
