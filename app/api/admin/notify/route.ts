...
function buildPreviewEmail(name: string, message?: string): string {
  return `
    <div style="font-family:'Hanken Grotesk',Georgia,serif;max-width:600px;margin:0 auto;padding:40px 48px;background:#EAE2D5;color:#241E1A;line-height:1.65;">
      ...
      <h2 style="font-family:'Playfair Display',serif;font-weight:400;font-size:22px;letter-spacing:-0.01em;color:#241E1A;margin:0 0 28px;border-bottom:1px solid #C4B59D;padding-bottom:14px;">
