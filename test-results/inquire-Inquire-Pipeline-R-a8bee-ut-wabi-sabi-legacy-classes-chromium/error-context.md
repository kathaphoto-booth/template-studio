...
- Name: inquire.spec.ts >> Inquire Pipeline Redesign - Aesthetic Verification >> should render perfectly symmetrical layout without wabi-sabi legacy classes
- Location: tests/inquire.spec.ts:4:3
...
Call log:
  - waiting for locator('.max-w-3xl').first()
