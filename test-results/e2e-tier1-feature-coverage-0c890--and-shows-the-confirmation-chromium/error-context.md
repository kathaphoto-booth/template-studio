...
- Name: e2e/tier1-feature-coverage/f7_template_selection.spec.ts >> F7: Template Selection - Tier 1 Happy Path >> T1.4: submits a personalized design inquiry and shows the confirmation
- Location: tests/e2e/tier1-feature-coverage/f7_template_selection.spec.ts:37:3
...
Call log:
  - waiting for getByRole('dialog').getByLabel('First name')
...
- generic [ref=e1]:
  - main [ref=e2]:
    ...
    - dialog "Katha Signature — Heirloom Piña" [ref=e1343]:
      - generic [ref=e1345]:
        - generic [ref=e1346]:
          - generic [ref=e1347]:
            - generic [ref=e1348]: Step 01 · Personalize
            - heading "Katha Signature — Heirloom Piña" [level=2] [ref=e1349]
          - button "Close and return to gallery" [active] [ref=e1350]:
            - img [ref=e1351]
        - generic [ref=e1355]:
          - generic [ref=e1356]:
            - heading "Your details" [level=3] [ref=e1357]
            - generic [ref=e1358]:
              - generic [ref=e1359]: Full name
              - textbox "Full name" [ref=e1360]:
                - /placeholder: E.g., Clara & Henry
            - generic [ref=e1361]:
              - generic [ref=e1362]: Email address
              - textbox "Email address" [ref=e1363]:
                - /placeholder: hello@example.com
            - generic [ref=e1364]:
              - generic [ref=e1365]: Phone number
              - textbox "Phone number" [ref=e1366]:
                - /placeholder: +1 (555) 000-0000
          - generic [ref=e1367]:
            - heading "The event" [level=3] [ref=e1368]
            - generic [ref=e1369]:
              - generic [ref=e1370]: Event date
              - textbox "Event date" [ref=e1371]:
                - /placeholder: ""
            - generic [ref=e1372]:
              - generic [ref=e1373]: Venue name
              - textbox "Venue name" [ref=e1374]:
                - /placeholder: E.g., The Grand Oak Manor
            - generic [ref=e1375]:
              - generic [ref=e1376]: Venue address
              - textbox "Venue address" [ref=e1377]:
                - /placeholder: City, State
          - generic [ref=e1378]:
            - heading "Design preferences" [level=3] [ref=e1379]
            - generic [ref=e1380]:
              - generic [ref=e1381]: Typography style
              - combobox "Typography style" [ref=e1382]:
                - option "Select an option" [disabled] [selected]
                - option "Playfair Display (Serif)"
                - option "Hanken Grotesk (Sans)"
                - option "Inter (Mono)"
            - generic [ref=e1383]:
              - generic [ref=e1384]: Text position
              - combobox "Text position" [ref=e1385]:
                - option "Select an option" [disabled]
                - option "Bottom" [selected]
                - option "Top"
            - generic [ref=e1386]:
              - generic [ref=e1387]: Notes (optional)
              - textbox "Notes (optional)" [ref=e1388]:
                - /placeholder: Anything we should know about the room or the moment.
        - generic [ref=e1389]:
          - button "Back" [disabled]
          - button "Continue" [disabled] [ref=e1390]
  - button "Open Next.js Dev Tools" [ref=e1396] [cursor=pointer]:
    - img [ref=e1397]
  - alert [ref=e1400]: Choose your style
```
