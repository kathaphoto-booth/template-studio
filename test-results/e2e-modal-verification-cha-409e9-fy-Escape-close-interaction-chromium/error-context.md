...
- Name: e2e/modal-verification-challenger.spec.ts >> Challenger Modal Interaction & Accessibility Verification >> verify Escape close interaction
- Location: tests/e2e/modal-verification-challenger.spec.ts:70:3
