...
export const LAYOUTS = {
  ...
  "strip-4": {
    id: "strip-4", label: "4 Stacked", format: "strip", slotCount: 4, singleLine: true,
    note: "Four photos, single-line caption band",
    slots: [R(60, 120, 480, 320), R(60, 470, 480, 320), R(60, 820, 480, 320), R(60, 1170, 480, 320)],
    textZone: R(60, 1520, 480, 220),
  },
  ...
  "pc-4": {
    id: "pc-4", label: "4 Quad", format: "postcard", slotCount: 4, singleLine: true,
    note: "Compressed 2×2 grid, single-line caption",
