...
export const LAYOUTS = {
  ...
  // pc-1-sq (1 Centered Square - DEPRECATED in favor of pc-1-full)
  "pc-1-sq": {
    id: "pc-1-sq", label: "1 Square (Legacy)", format: "postcard", slotCount: 1, singleLine: false,
    note: "Single square placeholder, text pedestal below",
    slots: [R(520, 100, 760, 760)],
    textZone: R(100, 880, 1600, 220),
    deprecated: true
  },
  // pc-1-full (1 Full Landscape)
  "pc-1-full": {
  ...
  "pc-3-v": {
    ...
    slots: [R(100, 100, 480, 760), R(640, 100, 480, 760), R(1180, 100, 480, 760)],
    textZone: R(100, 880, 1600, 220),
  },
  // pc-3-sq (3 Squares)
  "pc-3-sq": {
