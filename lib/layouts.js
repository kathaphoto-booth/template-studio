...
//    3-row  : three 480×700 columns (gap 80) · text band 1600×240
...
export const LAYOUTS = {
  ...
  "strip-4": {
    ...
    slots: [R(60, 110, 480, 310), R(60, 450, 480, 310), R(60, 790, 480, 310), R(60, 1130, 480, 310)],
    textZone: R(60, 1470, 480, 280),
  },
  ...
  "pc-1": {
    id: "pc-1", label: "1 Landscape", format: "postcard", slotCount: 1, singleLine: false,
    note: "Single large cinematic focal photo, text band below",
    slots: [R(100, 100, 1600, 750)],
    textZone: R(100, 900, 1600, 200),
  },
  "pc-2": {
    id: "pc-2", label: "2 Side by Side", format: "postcard", slotCount: 2, singleLine: false,
    note: "Top pair on the museum grid, full text band below",
    slots: [R(100, 100, 750, 450), R(950, 100, 750, 450)],
    textZone: R(100, 650, 1600, 450),
  },
  "pc-3": {
    id: "pc-3", label: "3 in a Row", format: "postcard", slotCount: 3, singleLine: false,
    note: "Three columns (80u gap), text band below",
    slots: [R(100, 100, 480, 700), R(660, 100, 480, 700), R(1220, 100, 480, 700)],
    textZone: R(100, 860, 1600, 240),
  },
  "pc-L": {
    id: "pc-L", label: "L-Shape", format: "postcard", slotCount: 3, singleLine: false,
    note: "Gemini L — photo·TEXT over photo·photo (perfect balance)",
    slots: [R(100, 100, 750, 450), R(100, 650, 750, 450), R(950, 650, 750, 450)],
    textZone: R(950, 100, 750, 450),
  },
  "pc-invL": {
    id: "pc-invL", label: "Inverted L", format: "postcard", slotCount: 3, singleLine: false,
    note: "Gemini inverted-L — photo·photo over TEXT·photo",
    slots: [R(100, 100, 750, 450), R(950, 100, 750, 450), R(950, 650, 750, 450)],
    textZone: R(100, 650, 750, 450),
  },

  // ─── SQUARE-SLOT LANDSCAPE VARIANTS ───────────────────────────────────
  // Each slot is 550×550 (square). Museum matting = 100.
  // Canvas 1800×1200. Slots fit within the top region leaving a clean text band.
  "pc-1-sq": {
    id: "pc-1-sq", label: "1 Square", format: "postcard", slotCount: 1, singleLine: false,
    note: "Single centered square photo, generous text band below",
    slots: [R(625, 80, 550, 550)],
    textZone: R(100, 700, 1600, 400),
  },
  "pc-2-sq": {
    id: "pc-2-sq", label: "2 Squares", format: "postcard", slotCount: 2, singleLine: false,
    note: "Two square photos side by side, text band below",
    slots: [R(100, 80, 550, 550), R(1150, 80, 550, 550)],
    textZone: R(100, 700, 1600, 400),
  },
  "pc-3-sq": {
    id: "pc-3-sq", label: "3 Squares", format: "postcard", slotCount: 3, singleLine: false,
    note: "Three square photos across, text band below",
    slots: [R(100, 80, 550, 550), R(625, 80, 550, 550), R(1150, 80, 550, 550)],
    textZone: R(100, 700, 1600, 400),
  },
